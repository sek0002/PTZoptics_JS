...
a = Analysis(
    ['main1.py'],
    pathex=['\\\\Mac\\Home\\Library\\CloudStorage\\OneDrive-PeterMac\\Documents\\DCC\\PTZoptics_JS'],
    binaries=pygame_binaries,
    datas=[('PTZOptics-VISCA-over-IP-Rev-1_2-8-20.pdf', '.'), ('assets', 'assets')] + pygame_datas,
    hiddenimports=hiddenimports,
    hookspath=[],
    hooksconfig={},
    runtime_hooks=['\\\\Mac\\Home\\Library\\CloudStorage\\OneDrive-PeterMac\\Documents\\DCC\\PTZoptics_JS\\runtime_hook_appdata.py'],
    excludes=[],
