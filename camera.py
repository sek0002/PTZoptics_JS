...
class Camera:
    ...
    def _send_visca_frame(self, frame_hex: str) -> Optional[bytes]:
        ...
        The provided hex is the VISCA payload carried inside VISCA-over-IP (starts with 0x81, ends with 0xFF).
        Returns the first response body payload bytes (without leading addr/status and trailing 0xFF),
        matching _send_command() behavior.
        """
